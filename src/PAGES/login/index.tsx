...
import { passwordValidator } from '../../UTILS/input-validator';
import SocialLogin from '../register/component/social-login';
import xcelearn from '../../../public/Logo_Xcelearn.png';
import signin_logo from '../../../public/signin_logo.svg';
import { axios_login, axios_loginByToken } from './axios';
...
const LoginPage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
          ...
          <Typography sx={{ marginLeft:'1%', fontSize: '14px' , borderSpacing: '10%' }}>
              English
          </Typography>
          <Button
        onClick={() =>('/register')}
  ...
  <Box
      ...
      >
        <img src={xcelearn} style={{ height: 'auto', maxWidth: '170px', marginTop:'5%'}} />
      </Box>
      ...
      <Box sx={{ 
        ...
        <img src={signin_logo}  style={{ width: '170px', height: '200px',marginLeft: '20%',marginTop:'27%'}} />
        <Typography sx={{fontfamily: 'Folio Extra Bold'}}
        style={headline2}
        variant='h2'
        marginLeft='100px'
        ...
        <Typography sx={{textAlign: 'inherit', marginTop: '10px', marginLeft:'100px'}}
  ...
  <Grid item xs={12} sm={6} container justifyContent="center" alignItems="center"
      ...
      <Box style={{ 
        ...
        marginTop:"10%"
            ...
            <Box sx={{ textAlign: 'center', marginTop: '20px' }}>
              <SocialLogin />
              <Divider sx={{marginBottom: '10px', marginTop: '10px', color:'#14171A'}}>
                <Typography
